...
public class RandomBenchmark{// Diese Klasse führt einen Benchmark-Test für die Klassen Random und SecureRandom durch, um die Laufzeiten zu vergleichen
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 1000000; i++) {// Schleife zur Ausführung von 1.000.000 Iterationen zur Messung der Laufzeit der Random-Klasse
        ...
        long Dauer = Endzeit - Startzeit;// Berechnung der Laufzeit des Schleifenblocks, indem die Endzeit von der Startzeit subtrahiert wird
        ...
        for (int i = 0; i < 1000000; i++) {// Schleife zur Ausführung von 1.000.000 Iterationen zur Messung der Laufzeit der SecureRandom-Klasse
        ...
        Endzeit = System.nanoTime();// Erneuter Abruf und Speicherung der aktuellen Zeit in Nanosekunden, um die Endzeit der Schleife zu kennen
